...
const HeroGallery = () => {
  return (
    <div className="flex gap-4 z-[10] p-5">
      <div className="flex flex-col gap-4">
        <div className="relative">
          <img src="images/hero/hero-1.png" alt="" />
          <a className="w-8 h-8 shadow-black shadow-2xl rounded-full bg-[#F85E9F] absolute bottom-[-16px] left-[-16px] flex justify-center items-center" href="#">
            <img
              src="icons/send.png"
              alt=""
              width={18}
      ...
      <div className=" flex justify-center items-center relative">
        ...
        <a className="w-8 h-8 rounded-full bg-[#FF5722] absolute bottom-0 left-8 flex justify-center items-center" href="#">
            <img
